...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    Context context;
    ArrayList<ImageModel> wallpaperArrayList;

    public Adapter(Context context, ArrayList<ImageModel> wallpaperArrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(context).load(wallpaperArrayList.get(position).getSrc().getPortrait()).into(holder.imageView);
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, SetWallpaper.class);
                intent.putExtra("image", wallpaperArrayList.get(position).getSrc().getPortrait());
